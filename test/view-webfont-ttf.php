...
<link rel="stylesheet" type="text/css" href="<?php echo $webfont->detected_url; ?>/css/webfont-css.php?font=ayar,ayuni,atku,aksn,anyn,awzo,awgg,attl,atdg,atzm,andw,apyt,atpt,atbg,atwt,atka,ajno,zawgyi-one,myanmar3,mymm,pdk,prb,tnln,taln,yko&format=ttf" />
...
?>
		...
		<?php echo $webfont->browser_name; ?> - <?php echo $webfont->browser_version; ?>
			...
			<code>
				&lt;link href='<?php echo $webfont->detected_url; ?>/css/webfont-css.php?font=ayar,ayartakhu,ayarkasone,ayarnayon,ayarwazo,ayarwagaung, ayartawthalin,ayarthadingyut,ayartazaungmone,ayarnatdaw, ayarpyatho,ayartapotwe,ayartabaung,ayartypewriter, ayarthawka,ayarjuno,zawgyi-one,myanmar3&format=ttf' rel='stylesheet' type='text/css'/&gt;
			</code>

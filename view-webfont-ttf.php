...
<link rel="stylesheet" type="text/css" href="<?php echo $webfont->detected_url; ?>/css-webfont.php?font=ayar,ayuni,atku,aksn,anyn,awzo,awgg,attl,atdg,atzm,andw,apyt,atpt,atbg,atwt,atka,ajno,zawgyi-one,myanmar3,mymm,pdk,prb,tnln,taln,yko&format=ttf" />
...
<!--img src="http://myanmapress.com/wp-content/themes/bluemotion/images/logo.png" width="250" height="50" alt="CDN MyanmaPress" /-->
   ...
   <div id="templatemo_menu">
			...
			<nav id="access" role="navigation">
				...
				<ul class="menu"><li id="menu-item-14" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-14"><a title="ဆိုဒ် အဖွင့်စာမျက်နှာ" href="http://www.myanmapress.com/">​အ​ဖွင့်​စာ​မျက်​နှာ</a></li>
